...
$(OBJ_DIR)/flappy: $(OBJ_DIR)/obstacles.o $(OBJ_DIR)/bird.o $(OBJ_DIR)/game.o $(OBJ_DIR)/welcome.o $(OBJ_DIR)/helpers.o
...
$(OBJ_DIR)/welcome.o: $(SRC_DIR)/welcome.c $(SRC_DIR)/externs.h $(SRC_DIR)/game.h $(SRC_DIR)/keys.h $(SRC_DIR)/helpers.h
	cc -c $< -o $@
